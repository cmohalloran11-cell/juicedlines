...
def _sport_from_pp_league(league: str | None) -> str:
    ...
    # full-game model would misproject against. NFLP is PrizePicks' distinct PRESEASON league
    # code (confirmed live 2026-08) and is excluded for the same reason CFL is — no engine
    # projects those games. CFL has no "nfl" substring and stays mapped to "other" anyway.
    if "nfl" in l:
